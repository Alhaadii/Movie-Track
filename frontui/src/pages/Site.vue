<template>
  <!-- heading section -->
  <header class="bg-blue-100 text-white shadow-md">
    <section class="max-w-6xl mx-auto p-4 text-blue-900">
      <div class="flex justify-between items-center">
        <div class="flex items-center space-x-1">
          <img
            ...
            alt="ice coffee"
          />
          <h1 class="uppercase text-blue-600 font-bold">Frappe-ui</h1>
        </div>
        <ul class="flex space-x-4">
          <li>
            <a
              class="transition-all transform delay-100 hover:text-gray-900 translate-y-4"
              href="#"
              >About</a
            >
          </li>
  ...
  <main class="bg-gray-100">
    <section class="max-w-6xl mx-auto p-4">
      <h2 class="text-3xl text-gray-800 font-bold">Welcome to Frappe-ui</h2>
      <p class="text-gray-600">
        A simple and easy to use UI library for Vue 3.0
      </p>
    </section>
  </main>
  <!-- Main  -->
      ...
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
                ...
                <g fill="none" fill-rule="evenodd">
                  <g transform="translate(0 -75)">
                    ...
                    <text
                      ...
                      font-weight="bold"
                    >
                      <tspan x="654" y="518">Frappe-ui</tspan>
                    </text>
                  </g>
                </g>
              </svg>
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2
                class="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600"
              >
                Company
              </h2>
            </div>
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            ...
            <ul class="leading-8">
              <li>
                <a href="#" class="hover:text-blue-400"
                  >Getting Started With HTML and CSS</a
                >
              </li>
              <li>
                <a href="#" class="hover:text-blue-400"
                  >What Is Flex And When to Use It?</a
                >
              </li>
              <li>
                <a href="#" class="hover:text-blue-400"
                  >How TailwindCSS Can Help Your Productivity?</a
                >
              </li>
              <li>
                <a href="#" class="hover:text-blue-400"
                  >5 Tips to Make Responsive Website</a
                >
              </li>
